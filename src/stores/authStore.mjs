...
import api, { endpoint } from '@/libs/api.mjs';
import { getLocalStorageItem, setLocalStorageItem } from '@/libs/localStorageHelpers.mjs';
...
export { useAuthStore, login, logout, init, isLoggedIn, };
