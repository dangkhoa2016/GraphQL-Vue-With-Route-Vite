				...
				<div class="card-body">
					<div class="d-flex flex-column align-items-center text-center">
						<img
							:src="avatarUrl"
							width="150"
							class="rounded-circle skeleton-img"
							:alt="user?.name"
						...
						<div class="my-3">
							...
							<p
								class="text-secondary profile-job mb-1 w-100"
								:class="{ skeleton: loading }"
							>
						...
						<ToggleFollowUser
							v-if="showToggleFollow"
							:user="user"
							:loading="loading"
							btn-follow-class="btn-outline-primary"
							:is-error="!loading && !user"
				...
				<ul class="list-group list-group-flush">
					...
					>
						...
						<span
							...
							:class="{ 'stats-count skeleton m-0': loading }"
						>
					...
					>
						<div class="d-flex align-items-center">
							<img
								src="/src/assets/images/cat-icon.png"
								width="32"
								class="me-1"
							/>
							Cats
