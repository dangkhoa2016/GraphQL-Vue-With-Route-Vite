<template>
	<ul class="social mb-0 mt-3 list-group">
		...
		<li
			class="list-group-item px-2 d-flex justify-content-between align-items-center text-muted small"
		>
			<div>
		...
		>
			...
			<a
				href="#"
				class="text-decoration-none text-success text-opacity-50"
		...
		>
			...
			<button
				...
				title="View more details about this cat"
...
<script setup>
	...
	const openOwnerDetail = () => {
		...
		router.push({ name: 'UserDetail', params: { id: props.cat?.user_id } });
	};
