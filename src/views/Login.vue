<template>
	<div class="row main-content d-flex rounded-5 border-success border mx-auto">
		<div
			class="col-md-4 rounded-5 rounded-end-0 text-center company__info d-none d-md-flex"
		>
...
<script setup>
	...
	import { useAuthStore, login } from '@/stores/authStore.mjs';
